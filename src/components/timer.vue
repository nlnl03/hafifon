    ...
    methods:{
            ...
            .then(success=>{
                if(success){
                    this.$swal({
                        ...
                        this.$router.push({name:'submitted',params:{Title:this.routeName}})
                      })
                }
                else{
                    this.$swal({
        ...
        getIdOfgroup(){
         ...
         async deletePer(){
            ...
            try{
                const res = await axios.post(this.$sharePointUrl+`getByTitle('${this.routeName}')/roleassignments/getbyprincipalid('${this.groupId}')`,{
        ...
        getPermListId(){
              return axios.get(this.$sharePointUrl+`getByTitle('isPermissionActive')/items?$filter=type eq '${this.routeName}'`)
        ...
        async updatePerm(){
            ...
            try{
                const res = await axios.post(this.$sharePointUrl+`getByTitle('isPermissionActive')/Items('${this.PermListId}')`,{
                '__metadata':{'type':'SP.Data.IsPermissionActiveListItem'},
                isAllow:false
             },
             {
