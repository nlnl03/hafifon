        ...
        <div class="name-progress-details">
          <div class="personal-info">
            <div class="personal-info-items">
              <div class="inner-right-flex">
                ...
                <div class="hafifa-nickname">חפיפון מתחיל</div>
              </div>
          ...
          <div class="progress-info">
            <div class="users-progress-item">
              <div class="title" v-if="isLoadForSpinner">
                כמה עברתי מהחפיפה ?
              </div>
              <div class="spinner-for-progress" v-if="!isLoadForSpinner">
                <loadingSpinner />
              </div>
  ...
  methods: {
    imgSrc() {
      ...
      if (this.imgUrl.split("").filter((c) => c === "?").length > 1) {
        ...
        var modifiedString =
          this.imgUrl.slice(0, indexToRemove) +
          this.imgUrl.slice(indexToRemove + 1);
